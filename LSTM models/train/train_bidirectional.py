...
parser.add_argument('--save', type=str, default=os.path.abspath(os.path.join(os.pardir,'Text_Imputation-master/models/model.pt')),
...
parser.add_argument('--dict', type=str, default=os.path.abspath(os.path.join(os.pardir,'Text_Imputation-master/dictionary/dict.pt')),
