...
parser.add_argument('--data', type=str, default=os.path.abspath(os.path.join(os.pardir,'Text_Imputation-master/data/')),
...
parser.add_argument('--save', type=str, default=os.path.abspath(os.path.join(os.pardir,'Text_Imputation-master/models/model_attn.pt')),
...
parser.add_argument('--dict', type=str, default=os.path.abspath(os.path.join(os.pardir,'Text_Imputation-master/dictionary/dict_attn.pt')),
...
def batchify(data, bsz, bptt):
    ...
    nbatch = ((data.size(0) // bptt) // bsz) * bptt
...
def get_batch(source, i):
    seq_len = min(args.bptt-2, len(source) - 1 - i)
