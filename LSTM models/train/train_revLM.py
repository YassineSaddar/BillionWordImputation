...
parser.add_argument('--data', type=str, default=os.path.abspath(os.path.join(os.pardir,'Text_Imputation-master/data/penn/')),
...
parser.add_argument('--save', type=str, default=os.path.abspath(os.path.join(os.pardir,'Text_Imputation-master/models/model_right.pt')),
